...
void readSolData(const std::string& filepath, NBNdataVecInt& nbn_data) {
...
void testReadFile() {
	...
	//readCWIDNsolThreadTask(pro.get(),
	//	totalData,
	//	from, to,
	//	firstFlag, nbn_data);

	//std::cout << totalData.back().get() << std::endl;
	//std::cout << totalData.front().get() << std::endl;
	//int stop = -1;
}

void generateSolutionsAround(const ofec::SolBase& curSol) {
