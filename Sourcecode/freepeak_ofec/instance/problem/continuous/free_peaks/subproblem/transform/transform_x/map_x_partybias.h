...
namespace ofec {
    ...
    namespace free_peaks {
        ...
        /// @brief Party-specific bias transformation for multimodal multi-party optimization
        /// 
        /// This transform implements party-specific landscape modifications as suggested by CEC MMOP benchmarks.
        ...
        /// 
        /// Reference: CEC2015 Multi-Niche Optimization Technical Report
        ...
        protected:
            ...
            // Recommended parameter ranges for systematic experimentation
