...
namespace ofec::free_peaks {
	...
	void ParamIO::writeSizes(std::ofstream& out, size_t num_vars, size_t num_objs, size_t num_cons) {
		out << "number_of_variables" << "\t" << num_vars << std::endl;
		out << "number_of_objectives" << "\t" << num_objs << std::endl;
		out << "number_of_constraints" << "\t" << num_cons << std::endl;
	}
